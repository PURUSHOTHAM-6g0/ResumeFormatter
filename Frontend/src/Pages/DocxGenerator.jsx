...
// Function to create links for header in DOCX
const createHeaderLinks = (links) => {
...
const createStyledSections = (data) => {
  ...
  // Create header table with name and logo
        ...
        children: [
          ...
          new TableCell({
            children: [
              ...
              // Add links directly in the header cell
              Array.isArray(data.links) && data.links.length > 0 ? createHeaderLinks(data.links) : new Paragraph({}),
            ],
            verticalAlign: VerticalAlign.CENTER,
            shading: { fill: "000000" },
